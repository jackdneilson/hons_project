...
\todo{Talk about face recog library as well as why chose that one}
\subsection{Test Server}
\todo{Talk about nginx vs others}
\todo{Talk about python webserver}
\todo{Talk about dynamic json generation}
\subsection{Portable Module}
\todo{Talk about split between module and run.py}
\subsection{Threading}
\todo{Talk about control from main thread}
\todo{Talk about prod/con}
\subsection{Headless}
\todo{Talk about cmd line args}
\todo{Talk about results}
\subsection{Social Network Interactivity}
\todo{Talk about mirrored structure}
