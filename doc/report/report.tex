...
While comparing images stored as Red-Green-Blue, accuracy rates were consistently over 90%. This dropped considerably when comparing greyscale images, such as the ones from the SCFace database. It is theorised that the facial recognition algorithm was less successful at finding facial descriptors in these images because of the lack of colour.
...
\newpage
\includepdf[scale=0.75,pagecommand=\section{Poster}, offset=0 -0.5cm]{res/1506801_poster}

\includepdf[pages=1,pagecommand=\section{Ethics Form}, offset=0 -3cm]{res/1506801_ethics_form}
\includepdf[pages=2-4]{res/1506801_ethics_form}

\includepdf[scale=0.95,pages=1,pagecommand=\section{Proposal}, offset=0 -0.5cm]{res/1506801_proposal}
\includepdf[scale=0.95,pages=2-5]{res/1506801_proposal}
