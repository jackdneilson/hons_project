...
The software will be tested using a comination of publicly available face recognition datasets including Labeled Faces in the Wild, the AT\&T Face database, the Essex Facial Recognition database and the SCFace database. \todo{Implement testing for the other 3}
...
\begin{itemize}
\item{The facial recognition part of the application should replicate the success rate of the library it uses.}
...
\end{itemize}
\todo{Maybe do a proof for deadlock?}

\subsection{Testing Strategy}https://www.facebook.com/
...
\subsubsection{Searching on an IR Data Set}

\subsection{Expected Results}
\subsubsection{Reproducing Facial Recognition Results}
The application should produce the same accuracy across the LFW data set as was produced in the wrapping library - 99.38\%.
